    ...
    <body>
        ...
        <table class="table table-bordered" >
            <tr style="background-color:#B955CF ; color:#080808;" class="text-center"> 
                    ...
                    <?php
                        include('../Connection.php');
                        //  $sqlq="SELECT p.product_id, p.Name, c.CName,a.Email,p.Active,p.Image FROM product p INNER JOIN category c ON p.Category = c.category_id INNER JOIN admin a ON p.Created_By_User_id = a.email where c.Active= 'Yes' and p.Active='Yes';";
